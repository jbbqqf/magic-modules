...
* `disk_size_gb` - (Optional) The disk size, in gigabytes, to use on each remote Compute Engine worker instance. If unset, the service will choose a reasonable default.
